...
outputs=function_cache(cache_opts,@wm_log_process_core,{anal_opts,data});
...
for ii=1:iimax
    ...
    wm_log_processed.probe.freq.set(ii)=mean(data.wm_log.feedback.setpt(wm_red_mask_idx(1):wm_red_mask_idx(2)));
