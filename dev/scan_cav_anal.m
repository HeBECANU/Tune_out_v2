...
% subplot(3,3,1)
% plot(ai_dat.Data(3,sampl_start:demo_max))
% subplot(3,3,2)
% plot(pos_slope_mask)
% subplot(3,3,4)
% plot(ai_dat.Data(2,sampl_start:demo_max))
% subplot(3,3,5)
% plot(pos_scan_data)
...
for ii=1:5
    ...
    %             calc_pow_ratio()
                ...
                hold on
                plot(T_win,scan,'k.')
%                 plot(line_lims(1),zero_offset,'go')
%                 plot(line_lims(2),zero_offset,'go')
%                 plot(T_sweep(p_cent),pks_val(jj),'kx')
%
